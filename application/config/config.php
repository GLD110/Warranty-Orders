...
if( ENVIRONMENT == 'development'){
  $config['base_url']  = 'http://localhost:9080/butler/';
...
// APP Configuration
$config['APP_NAME'] = 'CountDown Timer';
...
$config['API_BASEURL'] = '/admin/';
$config['APP_REDIRECT_URL'] =  $config['base_url'] . 'install/';

$config['APP_STATE'] = md5( $config['APP_REDIRECT_URL'] . $config['APP_NAME'] );

// Private Mode
$config['PUBLIC_MODE'] = false;
$config['USE_REDIRECT'] = true;
$config['PRIVATE_SHOP'] = 'misthub-dev.myshopify.com';
$config['PRIVATE_API_URL'] = 'https://a20c0bbd4a2b5ba980b98addadaa4e16:e28dd3b91474db2fe70d0eb4ce6b4b00@misthub-dev.myshopify.com/admin/';   //Dev Shop
...
$config['SETTING_ITEMS'] = array(
  ...
  array(
    'field' => 'is_fab',
    'title' => 'Fab.com Managed',
    'type' => 'flag'
  ),*/
  array(
    'field' => 'shopify_api_call',
    'title' => 'Shopify API Sleep',
    'type' => 'flag'
  ),
  array(
    'field' => 'webhook',
